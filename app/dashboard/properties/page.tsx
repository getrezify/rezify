  ...
  return (
    <div className="animate-fade-up relative pb-6">
      ...
      <header className="pt-4">
        <h1 className="font-display text-3xl text-text">Properties</h1>
        <p className="mt-1 text-sm text-muted">Create and manage your units</p>
      </header>
      ...
      {planLoading || listLoading ? (
        ...
        <div className="mt-8 rounded-xl border border-red-500/50 bg-red-500/15 px-4 py-6">
          <h2 className="font-display text-xl text-red-300">
        ...
        <div className="mt-8 rounded-xl border border-accent/40 bg-[var(--accent-muted)] px-4 py-6">
          ...
          <p className="mt-2 text-sm text-muted">
            ...
            units at $5/unit/month, or upgrade to Pro for unlimited growth.
          </p>
          <Link
      ...
      {!planLoading && !listLoading && (
        <section className="mt-10">
          ...
          <p className="mt-1 text-sm text-muted">Rename or remove properties</p>
                ...
                >
                  {editingId === unit.id ? (
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <button
                        type="button"
                        onClick={() => void handleInlineSave(unit.id)}
                        disabled={isListActionLoading}
